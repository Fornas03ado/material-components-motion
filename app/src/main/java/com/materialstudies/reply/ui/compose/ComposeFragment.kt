...
class ComposeFragment : Fragment() {
    ...
    private fun expandChip(chip: View) {
        ...
        val transform = MaterialContainerTransform().apply {
            ...
            /* By default, TransitionManager will run the supplied transition on all views
            which are changing. Setting a target will ensure the container transform only
            runs on the single, specified target view. */
